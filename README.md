...
<h2>1. Mô tả</h2>
- Trang web bán máy thực phẩm bao gồm 2 thành phần chính: Quản trị và Client.
<h3>1.1. Trang quản trị</h3>
<p>- Trang quản trị có mục đích quản lý sản phẩm, quản lý nhóm sản phẩm, quản lý khách hàng, quản lý giỏ hàng</p>
...
<ul>
  <li>Tên sản phẩm</li>
  <li>Kích thước sản phẩm (chiều dài, chiều rộng, chiều cao)</li>
  <li>Số lượng</li>
  <li>Giá thành</li>
  <li>Mô tả</li>
  <li>Hình ảnh</li>
...
<p>- Trang quản lý nhóm sản phẩm có chức năng hiển thị danh sách tên các nhóm sản phẩm</p>
